...
export class MembersService {
    ...
    async changePassword(
        ...
        const isCurrentPasswordValid = await bcrypt.compare(dto.currentPassword, eligibleMember.password);
    ...
    private toMemberProfileResponse(member: MemberDocument): MemberProfileResponse {
