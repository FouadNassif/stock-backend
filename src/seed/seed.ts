...
async function createStocks(models: SeedModels): Promise<Record<string, Types.ObjectId>> {
    ...
    return Object.fromEntries(
        stocks.map((stock) => [stock.ticker, stock._id]),
...
function printSeedSummary(data: {
    ...
    console.log('- Use negative.seed@example.com for negative balance alert tests.');
}
