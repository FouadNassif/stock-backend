...
export function buildPasswordResetOtpEmailTemplate(params: {
  fullName: string;
  code: string;
}): string {
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px; background-color:#ffffff; border-radius:14px; overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.08);">
                ...
                <tr>
                  <td style="padding:36px 32px 24px;">
                    ...
                    <div style="background-color:#f8fafc; border:1px solid #e5e7eb; border-radius:12px; padding:24px; margin:28px 0; text-align:center;">
                      <p style="margin:0 0 10px; color:#64748b; font-size:13px; text-transform:uppercase; letter-spacing:0.8px;">
                        Password Reset Code
                      </p>

                      <p style="margin:0; color:#111827; font-size:34px; font-weight:800; letter-spacing:6px;">
                        ${code}
                      </p>
                    </div>
